...
def question10_2():
    answer=True     # The correlation value between 2 real values vary between -1(strong -ve correlation) and 1 (strong +ve correlation)
    return answer

def question10_3():
    answer=False    # Sampling might lead to information loss which is important in the case of time series. 
    return answer

def question10_4():
    answer=True     # Certainly all the outliers are not always noise, but in few cases
    return answer

def question10_5():
    answer=False     # In a high level, noise is very inappropriate data, whereas outliers are those points that 
